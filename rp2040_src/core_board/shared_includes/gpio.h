...
#define C_GPIO_INIT_MASK 0x1C70FFFF
#define C_GPIO_AD_MASK 0x0000FFFF
#define C_GPIO_D_MASK 0x000000FF
#define C_GPIO_TXVR_MASK 0x18400000
#define C_GPIO_ADDR_IN_VALUE 0x10400000
#define C_GPIO_DATA_READ_VALUE 0x08400000
#define C_GPIO_DATA_WRITE_VALUE 0x08000000
#define C_GPIO_DIR_VALUE 0x1C400000
